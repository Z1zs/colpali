...
from colpali_engine.loss.late_interaction_losses import ColbertLoss, ColbertPairwiseCELoss, MetaEmbedMatryoshkaLoss
from colpali_engine.models import MetaQwen2_5, ColQwen2_5_Processor
...
if __name__ == "__main__":
    ...
    if args.loss == "ce":
        ...
        base_loss = ColbertPairwiseCELoss(
    ...
    loss_func = MetaEmbedMatryoshkaLoss(
    ...
    config = ColModelTrainingConfig(
        ...
        processor=ColQwen2_5_Processor.from_pretrained(
            pretrained_model_name_or_path="/hpc2hdd/home/jhuo219/models/colqwen2.5-v0.2",
            max_num_visual_tokens=768,
        ),
        model=MetaQwen2_5.from_pretrained(
            pretrained_model_name_or_path="/hpc2hdd/home/jhuo219/models/colqwen2.5-v0.2",
            num_latent_tokens=1,
        ...
        eval_dataset=ColPaliEngineDataset(
            load_dataset("/hpc2hdd/home/jhuo219/models/vidore/colpali_train_set", split="test"), pos_target_column_name="image"
        ),
        run_eval=True,
        loss_func=loss_func,
